...
public class SignUpPageJBehave extends PageObject {
    ...
    public SignUpPageJBehave typeEmail(String email) {
        find(emailField).sendKeys(email);
        return this;
    }

    public SignUpPageJBehave typeConfirmEmail(String email) {
        find(confirmEmail).sendKeys(email);
        return this;
    }

    public SignUpPageJBehave typePassword(String pass) {
        find(password).sendKeys(pass);
        return this;
    }

    public SignUpPageJBehave typeRegName(String name) {
        find(registeredName).sendKeys(name);
        return this;
    }


    public SignUpPageJBehave selectBirthMonth(String month) {
        find(birthMonthField).click();
        find(By.xpath(String.format(monthDropDownOptions, month))).waitUntilVisible().click();
        return this;
    }

    public SignUpPageJBehave typeBirthDay(String day) {
        find(birthDay).sendKeys(day);
        return this;
    }

    public SignUpPageJBehave typeBirthYear(String year) {
        find(birthYear).sendKeys(year);
        return this;
    }

    public SignUpPageJBehave typeSex(String value) {
        find(By.xpath(String.format(sexRadioButton, value))).click();
        return this;
    }

    public SignUpPageJBehave setSharingCheckBox(boolean value) {
